...
- [ ] **DST-safe EXIF TZ safeguard** — apply DST-safe EXIF TZ safeguard (resolve offset from IANA zone on the photo's own date, not `dt.astimezone()` current offset) + add Jan/Jul Europe/Zurich offset test (mirrors zkm-scan owner decision 2026-06-13). ROADMAP id:33e5. (was inbox routed:5a69 from zkm-scan) <!-- id:aaa3 -->
